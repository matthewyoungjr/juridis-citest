/*
Author : Matthew Ojukwu Young Jr
Contact Me : hawkeyeanon@protonmail.com
File : Main.js
*/
...
(function () {
  ...
  function documentReadyInit() {
    ...
    if (jQuery().tweet) {
      jQuery(".twitter").tweet({
        ...
        template:
          '<div class="tweet_right">{time}{join}<span class="tweet_text">{tweet_text}</span></div>',
      });
    }
  ...
  //function that initiating  plugins on window.load event
  function windowLoadInit() {
    ...
    if (jQuery().flexslider) {
      ...
      $introSlider.each(function (index) {
        ...
        var nav =
          $currentSlider.data("nav") != "undefined"
            ? $currentSlider.data("nav")
            : true;
        var dots =
          $currentSlider.data("dots") != "undefined"
            ? $currentSlider.data("dots")
            : true;
